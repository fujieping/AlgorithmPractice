...
//         else
//         {
//             fprintf(fp, "%s  %s  %d  %s  %s", stu->name, stu->sex, stu->age, stu->telephone, stu->address);
//         }
...
//         if (fscanf(fp, "%s  %s  %d  %s  %s", stu[idx].name, stu[idx].sex, &stu[idx].age, stu[idx].telephone, stu[idx].address) != EOF)
//         {
